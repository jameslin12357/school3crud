...
router.get('/', function(req, res, next) {
    if (req.isAuthenticated()) {
        client.query('SELECT * FROM addresses ORDER BY date_created DESC; SELECT count(*) as count FROM addresses',
...
router.get('/users/:id', isResource, isAuthenticated, function(req, res){
    client.query(`SELECT id, email, username, description, imageurl, date_created, level FROM users WHERE id = '${req.params.id}'`,
        function (error, results) {
            // error will be an Error if one occurred during the query
            // results will contain the results of the query
            // fields will contain information about the returned results fields (if any)
...
router.get('/users/:id/edit', isResource, isAuthenticated, function(req, res){
    if (req.user.id === Number(req.params.id)){
        client.query(`SELECT id, email, username, description FROM users WHERE id = '${req.params.id}'`,
            function (error, results) {
                // error will be an Error if one occurred during the query
                // results will contain the results of the query
                // fields will contain information about the returned results fields (if any)
...
router.put('/users/:id', isResource, isAuthenticated, function(req, res, next){
    ...
    if (!errors.isEmpty()) {
        ...
        client.query(`UPDATE users SET email = '${email}', username = '${username}', description = '${description}' WHERE id = '${req.params.id}'`,
            function (error, results) {
                // error will be an Error if one occurred during the query
                // results will contain the results of the query
                // fields will contain information about the returned results fields (if any)
...
router.delete('/users/:id', isResource, isAuthenticated, function(req, res, next){
    ...
    client.query(`DELETE FROM users WHERE id = '${req.params.id}'`, function (error, results) {
        // error will be an Error if one occurred during the query
        // results will contain the results of the query
        // fields will contain information about the returned results fields (if any)
        if (error) {
...
router.post('/addresses', isAuthenticated, function(req, res, next) {
    ...
    , (req, res) => {
        ...
        if (!errors.isEmpty()) {
            ...
            client.query(`INSERT INTO addresses (building_number, street, city, state, country, zip) 
...
router.get('/addresses/:id/edit', isResource, isAuthenticated, function(req, res) {
    if (req.user.level === 1){
        client.query(`SELECT id, building_number, street, city, state, country, zip FROM addresses WHERE id = '${req.params.id}'`,
...
router.put('/addresses/:id', isResource, isAuthenticated, function(req, res, next) {
    ...
    if (!errors.isEmpty()) {
        ...
        const country = req.body.country;
        const zip = req.body.zip;
        client.query(`UPDATE addresses SET building_number = '${building_number}', street = '${street}', city = '${city}', state = '${state}',
            country = '${country}', zip = '${zip}' WHERE id = '${req.params.id}'`,
            function (error, results) {
                // error will be an Error if one occurred during the query
                // results will contain the results of the query
                // fields will contain information about the returned results fields (if any)
...
router.delete('/addresses/:id', isResource, isAuthenticated, function(req, res, next) {
    if (req.user.level === 1){
        client.query(`DELETE FROM addresses WHERE id = '${req.params.id}'`, function (error, results) {
            // error will be an Error if one occurred during the query
            // results will contain the results of the query
            // fields will contain information about the returned results fields (if any)
            if (error) {
...
router.get('/attendances', function(req, res, next) {
    if (req.isAuthenticated()) {
        client.query('SELECT * FROM attendances ORDER BY date_created DESC; SELECT count(*) as count FROM attendances',
            function (error, results) {
                if (error) {
                    throw error;
                }
...
router.post('/attendances', isAuthenticated, function(req, res, next) {
    ...
    , (req, res) => {
        ...
        if (!errors.isEmpty()) {
            ...
            client.query(`INSERT INTO attendances (student_id) VALUES ('${student_id}')`,
                function (error, results) {
                    // error will be an Error if one occurred during the query
                    // results will contain the results of the query
                    // fields will contain information about the returned results fields (if any)
...
router.get('/attendances/:id/edit', isResource, isAuthenticated, function(req, res) {
    if (req.user.level === 1){
        client.query(`SELECT id, student_id FROM attendances WHERE id = '${req.params.id}'`,
            function (error, results, fields) {
                // error will be an Error if one occurred during the query
                // results will contain the results of the query
                // fields will contain information about the returned results fields (if any)
...
router.put('/attendances/:id', isResource, isAuthenticated, function(req, res, next) {
    ...
    if (!errors.isEmpty()) {
        ...
        sanitizeBody('student_id').trim().escape();
        const student_id = req.body.student_id;
        client.query(`UPDATE attendances SET student_id = '${student_id}' WHERE id = '${req.params.id}'`,
            function (error, results) {
                // error will be an Error if one occurred during the query
                // results will contain the results of the query
                // fields will contain information about the returned results fields (if any)
...
router.delete('/attendances/:id', isResource, isAuthenticated, function(req, res, next) {
    if (req.user.level === 1){
        client.query(`DELETE FROM attendances WHERE id = '${req.params.id}'`, function (error, results) {
            // error will be an Error if one occurred during the query
            // results will contain the results of the query
            // fields will contain information about the returned results fields (if any)
            if (error) {
...
router.get('/courses', function(req, res, next) {
    if (req.isAuthenticated()) {
        client.query('SELECT * FROM courses ORDER BY date_created DESC; SELECT count(*) as count FROM courses',
            function (error, results, fields) {
                if (error) {
                    throw error;
                }
...
router.post('/courses', isAuthenticated, function(req, res, next) {
    ...
    , (req, res) => {
        ...
        if (!errors.isEmpty()) {
            ...
            client.query(`INSERT INTO courses (name, description, section_id, department_id, room_id) VALUES ('${name}','${description}','${section_id}','${department_id}','${room_id}')`,
                function (error, results) {
                    // error will be an Error if one occurred during the query
                    // results will contain the results of the query
                    // fields will contain information about the returned results fields (if any)
...
router.get('/courses/:id/edit', isResource, isAuthenticated, function(req, res) {
    if (req.user.level === 1){
        client.query(`SELECT id, name, description, section_id, department_id, room_id FROM courses WHERE id = '${req.params.id}'`,
            function (error, results) {
                // error will be an Error if one occurred during the query
                // results will contain the results of the query
                // fields will contain information about the returned results fields (if any)
...
router.put('/courses/:id', isResource, isAuthenticated, function(req, res, next) {
    ...
    if (!errors.isEmpty()) {
        ...
        const department_id = req.body.department_id;
        const room_id = req.body.room_id;
        client.query(`UPDATE courses SET name = '${name}', description = '${description}', section_id = '${section_id}', department_id = '${department_id}', room_id = '${room_id}' WHERE id = '${req.params.id}'`,
            function (error, results) {
                // error will be an Error if one occurred during the query
                // results will contain the results of the query
                // fields will contain information about the returned results fields (if any)
...
router.delete('/courses/:id', isResource, isAuthenticated, function(req, res, next) {
    if (req.user.level === 1){
        client.query(`DELETE FROM courses WHERE id = '${req.params.id}'`, function (error, results) {
            // error will be an Error if one occurred during the query
            // results will contain the results of the query
            // fields will contain information about the returned results fields (if any)
            if (error) {
...
router.get('/departments', function(req, res, next) {
    if (req.isAuthenticated()) {
        client.query('SELECT * FROM departments ORDER BY date_created DESC; SELECT count(*) as count FROM departments',
            function (error, results) {
                if (error) {
                    throw error;
                }
...
router.post('/departments', isAuthenticated, function(req, res, next) {
    ...
    , (req, res) => {
        ...
        if (!errors.isEmpty()) {
            ...
            client.query(`INSERT INTO departments (name, description, teacher_id) VALUES ('${name}','${description}','${teacher_id}')`,
                function (error, results) {
                    // error will be an Error if one occurred during the query
                    // results will contain the results of the query
                    // fields will contain information about the returned results fields (if any)
...
router.get('/departments/:id/edit', isResource, isAuthenticated, function(req, res) {
    if (req.user.level === 1){
        client.query(`SELECT id, name, description, teacher_id FROM departments WHERE id = '${req.params.id}'`,
            function (error, results, fields) {
                // error will be an Error if one occurred during the query
                // results will contain the results of the query
                // fields will contain information about the returned results fields (if any)
...
router.put('/departments/:id', isResource, isAuthenticated, function(req, res, next) {
    ...
    if (!errors.isEmpty()) {
        ...
        const description = req.body.description;
        const teacher_id = req.body.teacher_id;
        client.query(`UPDATE departments SET name = '${name}', description = '${description}', teacher_id = '${teacher_id}' WHERE id = '${req.params.id}'`,
            function (error, results) {
                // error will be an Error if one occurred during the query
                // results will contain the results of the query
                // fields will contain information about the returned results fields (if any)
...
router.delete('/departments/:id', isResource, isAuthenticated, function(req, res, next) {
    if (req.user.level === 1){
        client.query(`DELETE FROM departments WHERE id = '${req.params.id}'`, function (error, results) {
            // error will be an Error if one occurred during the query
            // results will contain the results of the query
            // fields will contain information about the returned results fields (if any)
            if (error) {
...
router.get('/genders', function(req, res, next) {
    if (req.isAuthenticated()) {
        client.query('SELECT * FROM genders ORDER BY date_created DESC; SELECT count(*) as count FROM genders',
            function (error, results) {
                if (error) {
                    throw error;
                }
...
router.post('/genders', isAuthenticated, function(req, res, next) {
    ...
    , (req, res) => {
        ...
        if (!errors.isEmpty()) {
            ...
            client.query(`INSERT INTO genders (gender) VALUES ('${gender}')`,
                function (error, results) {
                    // error will be an Error if one occurred during the query
                    // results will contain the results of the query
                    // fields will contain information about the returned results fields (if any)
...
router.get('/genders/:id/edit', isResource, isAuthenticated, function(req, res) {
    if (req.user.level === 1){
        client.query(`SELECT id, gender FROM genders WHERE id = '${req.params.id}'`,
            function (error, results, fields) {
                // error will be an Error if one occurred during the query
                // results will contain the results of the query
                // fields will contain information about the returned results fields (if any)
...
router.put('/genders/:id', isResource, isAuthenticated, function(req, res, next) {
    ...
    if (!errors.isEmpty()) {
        ...
        sanitizeBody('gender').trim().escape();
        const gender = req.body.gender;
        client.query(`UPDATE genders SET gender = '${gender}' WHERE id = '${req.params.id}'`,
            function (error, results) {
                // error will be an Error if one occurred during the query
                // results will contain the results of the query
                // fields will contain information about the returned results fields (if any)
...
router.delete('/genders/:id', isResource, isAuthenticated, function(req, res, next) {
    if (req.user.level === 1){
        client.query(`DELETE FROM genders WHERE id = '${req.params.id}'`, function (error, results) {
            // error will be an Error if one occurred during the query
            // results will contain the results of the query
            // fields will contain information about the returned results fields (if any)
            if (error) {
...
router.get('/rooms', function(req, res, next) {
    if (req.isAuthenticated()) {
        client.query('SELECT * FROM rooms ORDER BY date_created DESC; SELECT count(*) as count FROM rooms',
            function (error, results) {
                if (error) {
                    throw error;
                }
...
router.post('/rooms', isAuthenticated, function(req, res, next) {
    ...
    , (req, res) => {
        ...
        if (!errors.isEmpty()) {
            ...
            client.query(`INSERT INTO rooms (number) VALUES ('${number}')`,
                function (error, results) {
                    // error will be an Error if one occurred during the query
                    // results will contain the results of the query
                    // fields will contain information about the returned results fields (if any)
...
router.get('/rooms/:id/edit', isResource, isAuthenticated, function(req, res) {
    if (req.user.level === 1){
        client.query(`SELECT id, number FROM rooms WHERE id = '${req.params.id}'`,
            function (error, results, fields) {
                // error will be an Error if one occurred during the query
                // results will contain the results of the query
                // fields will contain information about the returned results fields (if any)
...
router.put('/rooms/:id', isResource, isAuthenticated, function(req, res, next) {
    ...
    if (!errors.isEmpty()) {
        ...
        sanitizeBody('number').trim().escape();
        const number = req.body.number;
        client.query(`UPDATE rooms SET number = '${number}' WHERE id = '${req.params.id}'`,
            function (error, results) {
                // error will be an Error if one occurred during the query
                // results will contain the results of the query
                // fields will contain information about the returned results fields (if any)
...
router.delete('/rooms/:id', isResource, isAuthenticated, function(req, res, next) {
    if (req.user.level === 1){
        client.query(`DELETE FROM rooms WHERE id = '${req.params.id}'`, function (error, results) {
            // error will be an Error if one occurred during the query
            // results will contain the results of the query
            // fields will contain information about the returned results fields (if any)
            if (error) {
...
router.get('/sections', function(req, res, next) {
    if (req.isAuthenticated()) {
        client.query('SELECT * FROM sections ORDER BY date_created DESC; SELECT count(*) as count FROM sections',
            function (error, results) {
                if (error) {
                    throw error;
                }
...
router.post('/sections', isAuthenticated, function(req, res, next) {
    ...
    , (req, res) => {
        ...
        if (!errors.isEmpty()) {
            ...
            client.query(`INSERT INTO sections (name, start_time, end_time) VALUES ('${name}','${start}','${end}')`,
                function (error, results) {
                    // error will be an Error if one occurred during the query
                    // results will contain the results of the query
                    // fields will contain information about the returned results fields (if any)
...
router.get('/sections/:id/edit', isResource, isAuthenticated, function(req, res) {
    if (req.user.level === 1){
        client.query(`SELECT id, name, start_time, end_time FROM sections WHERE id = '${req.params.id}'`,
            function (error, results) {
                // error will be an Error if one occurred during the query
                // results will contain the results of the query
                // fields will contain information about the returned results fields (if any)
...
router.put('/sections/:id', isResource, isAuthenticated, function(req, res, next) {
    ...
    if (!errors.isEmpty()) {
        ...
        const start = req.body.start;
        const end = req.body.end;
        client.query(`UPDATE sections SET name = '${name}', start_time = '${start}', end_time = '${end}' WHERE id = '${req.params.id}'`,
            function (error, results) {
                // error will be an Error if one occurred during the query
                // results will contain the results of the query
                // fields will contain information about the returned results fields (if any)
...
router.delete('/sections/:id', isResource, isAuthenticated, function(req, res, next) {
    if (req.user.level === 1){
        client.query(`DELETE FROM sections WHERE id = '${req.params.id}'`, function (error, results) {
            // error will be an Error if one occurred during the query
            // results will contain the results of the query
            // fields will contain information about the returned results fields (if any)
            if (error) {
...
router.get('/students', function(req, res, next) {
    if (req.isAuthenticated()) {
        client.query('SELECT * FROM students ORDER BY date_created DESC; SELECT count(*) as count FROM students',
            function (error, results) {
                if (error) {
                    throw error;
                }
...
router.post('/students', isAuthenticated, function(req, res, next) {
    ...
    , (req, res) => {
        ...
        if (!errors.isEmpty()) {
            ...
            client.query(`INSERT INTO students (first_name, last_name, age, dob, email, phone_number, gender_id, address_id) VALUES ('${first_name}','${last_name}','${age}','${dob}','${email}','${phone_number}','${gender_id}','${address_id}')`,
                function (error, results) {
                    // error will be an Error if one occurred during the query
                    // results will contain the results of the query
                    // fields will contain information about the returned results fields (if any)
...
router.get('/students/:id/edit', isResource, isAuthenticated, function(req, res) {
    if (req.user.level === 1){
        client.query(`SELECT id, first_name, last_name, age, dob, email, phone_number, gender_id, address_id FROM students WHERE id = '${req.params.id}'`,
            function (error, results) {
                // error will be an Error if one occurred during the query
                // results will contain the results of the query
                // fields will contain information about the returned results fields (if any)
...
router.put('/students/:id', isResource, isAuthenticated, function(req, res, next) {
    ...
    if (!errors.isEmpty()) {
        ...
        const gender_id = req.body.gender_id;
        const address_id = req.body.address_id;
        client.query(`UPDATE students SET first_name = '${first_name}', last_name = '${last_name}', age = '${age}', dob = '${dob}',
...
router.delete('/students/:id', isResource, isAuthenticated, function(req, res, next) {
    if (req.user.level === 1){
        client.query(`DELETE FROM students WHERE id = '${req.params.id}'`, function (error, results) {
            // error will be an Error if one occurred during the query
            // results will contain the results of the query
            // fields will contain information about the returned results fields (if any)
            if (error) {
...
router.get('/studentscourses', function(req, res, next) {
    if (req.isAuthenticated()) {
        client.query('SELECT * FROM studentscourses ORDER BY date_created DESC; SELECT count(*) as count FROM studentscourses',
            function (error, results) {
                if (error) {
                    throw error;
                }
...
router.post('/studentscourses', isAuthenticated, function(req, res, next) {
    ...
    , (req, res) => {
        ...
        if (!errors.isEmpty()) {
            ...
            client.query(`INSERT INTO studentscourses (grade, student_id, course_id) VALUES ('${grade}', '${student_id}','${course_id}')`,
                function (error, results) {
                    // error will be an Error if one occurred during the query
                    // results will contain the results of the query
                    // fields will contain information about the returned results fields (if any)
...
router.get('/studentscourses/:id/edit', isResource, isAuthenticated, function(req, res) {
    if (req.user.level === 1){
        client.query(`SELECT id, grade, student_id, course_id FROM studentscourses WHERE id = '${req.params.id}'`,
            function (error, results) {
                // error will be an Error if one occurred during the query
                // results will contain the results of the query
                // fields will contain information about the returned results fields (if any)
...
router.put('/studentscourses/:id', isResource, isAuthenticated, function(req, res, next) {
    ...
    if (!errors.isEmpty()) {
        ...
        const student_id = req.body.student_id;
        const course_id = req.body.course_id;
        client.query(`UPDATE studentscourses SET grade = '${grade}', student_id = '${student_id}', course_id = '${course_id}' WHERE id = '${req.params.id}'`,
            function (error, results) {
                // error will be an Error if one occurred during the query
                // results will contain the results of the query
                // fields will contain information about the returned results fields (if any)
...
router.delete('/studentscourses/:id', isResource, isAuthenticated, function(req, res, next) {
    if (req.user.level === 1){
        client.query(`DELETE FROM studentscourses WHERE id = '${req.params.id}'`, function (error, results) {
            // error will be an Error if one occurred during the query
            // results will contain the results of the query
            // fields will contain information about the returned results fields (if any)
            if (error) {
...
router.get('/teachers', function(req, res, next) {
    if (req.isAuthenticated()) {
        client.query('SELECT * FROM teachers ORDER BY date_created DESC; SELECT count(*) as count FROM teachers',
            function (error, results) {
                if (error) {
                    throw error;
                }
...
router.post('/teachers', isAuthenticated, function(req, res, next) {
    ...
    , (req, res) => {
        ...
        if (!errors.isEmpty()) {
            ...
            const gender_id = req.body.gender_id;
            const address_id = req.body.address_id;
            client.query(`INSERT INTO teachers (first_name, last_name, age, dob, email, phone_number, gender_id, address_id) VALUES ('${first_name}','${last_name}','${age}','${dob}','${email}','${phone_number}','${gender_id}','${address_id}')`,
                function (error, results) {
                    // error will be an Error if one occurred during the query
                    // results will contain the results of the query
                    // fields will contain information about the returned results fields (if any)
...
router.get('/teachers/:id/edit', isResource, isAuthenticated, function(req, res) {
    if (req.user.level === 1){
        client.query(`SELECT id, first_name, last_name, age, dob, email, phone_number, gender_id, address_id FROM teachers WHERE id = '${req.params.id}'`,
            function (error, results) {
                // error will be an Error if one occurred during the query
                // results will contain the results of the query
                // fields will contain information about the returned results fields (if any)
...
router.put('/teachers/:id', isResource, isAuthenticated, function(req, res, next) {
    ...
    if (!errors.isEmpty()) {
        ...
        const gender_id = req.body.gender_id;
        const address_id = req.body.address_id;
        client.query(`UPDATE teachers SET first_name = '${first_name}', last_name = '${last_name}', age = '${age}', dob = '${dob}',
            email = '${email}', phone_number = '${phone_number}', gender_id = '${gender_id}', address_id = '${address_id}' WHERE id = '${req.params.id}'`,
            function (error, results) {
                // error will be an Error if one occurred during the query
                // results will contain the results of the query
...
router.delete('/teachers/:id', isResource, isAuthenticated, function(req, res, next) {
    if (req.user.level === 1){
        client.query(`DELETE FROM teachers WHERE id = '${req.params.id}'`, function (error, results) {
            // error will be an Error if one occurred during the query
            // results will contain the results of the query
            // fields will contain information about the returned results fields (if any)
            if (error) {
...
router.get('/teacherscourses', function(req, res, next) {
    if (req.isAuthenticated()) {
        client.query('SELECT * FROM teacherscourses ORDER BY date_created DESC; SELECT count(*) as count FROM teacherscourses',
            function (error, results) {
                if (error) {
                    throw error;
                }
...
router.post('/teacherscourses', isAuthenticated, function(req, res, next) {
    ...
    , (req, res) => {
        ...
        if (!errors.isEmpty()) {
            ...
            const teacher_id = req.body.teacher_id;
            const course_id = req.body.course_id;
            client.query(`INSERT INTO teacherscourses (teacher_id, course_id) VALUES ('${teacher_id}','${course_id}')`,
                function (error, results) {
                    // error will be an Error if one occurred during the query
                    // results will contain the results of the query
                    // fields will contain information about the returned results fields (if any)
...
router.get('/teacherscourses/:id/edit', isResource, isAuthenticated, function(req, res) {
    if (req.user.level === 1){
        client.query(`SELECT id, teacher_id, course_id FROM teacherscourses WHERE id = '${req.params.id}'`,
            function (error, results) {
                // error will be an Error if one occurred during the query
                // results will contain the results of the query
                // fields will contain information about the returned results fields (if any)
...
router.put('/teacherscourses/:id', isResource, isAuthenticated, function(req, res, next) {
    ...
    if (!errors.isEmpty()) {
        ...
        const teacher_id = req.body.teacher_id;
        const course_id = req.body.course_id;
        client.query(`UPDATE teacherscourses SET teacher_id = '${teacher_id}', course_id = '${course_id}' WHERE id = '${req.params.id}'`,
            function (error, results) {
                // error will be an Error if one occurred during the query
                // results will contain the results of the query
                // fields will contain information about the returned results fields (if any)
...
router.delete('/teacherscourses/:id', isResource, isAuthenticated, function(req, res, next) {
    if (req.user.level === 1){
        client.query(`DELETE FROM teacherscourses WHERE id = '${req.params.id}'`, function (error, results) {
            // error will be an Error if one occurred during the query
            // results will contain the results of the query
            // fields will contain information about the returned results fields (if any)
            if (error) {
